...
export class WordService {
  ...
  constructor() {
    ...
    this.lists['osa-five'] = [
      ...
      { prompt: 'power', answer: 'ruler' },
      { prompt: 'clock', answer: 'church' },
      { prompt: 'language', answer: 'cattle' },
      { prompt: 'valley', answer: 'obedience' },
      { prompt: 'loss', answer: 'doubt' },
      { prompt: 'nephew', answer: 'steamship' },
      { prompt: 'growth', answer: 'pianist' },
      { prompt: 'pardon', answer: 'acoustic' },
      { prompt: 'painter', answer: 'meadow' },
      { prompt: 'demand', answer: 'mercy' },
      { prompt: 'butterfly', answer: 'settlement' },
      { prompt: 'swell', answer: 'reality' },
      { prompt: 'look', answer: 'horse' },
      { prompt: 'criticism', answer: 'grandmother' },
      { prompt: 'dream', answer: 'progress' },
      { prompt: 'discipline', answer: 'removal' },
      { prompt: 'marriage', answer: 'dawn' },
      { prompt: 'bungalow', answer: 'difficulty' },
      { prompt: 'twilight', answer: 'engagement' },
      { prompt: 'hostage', answer: 'bloom' },
      { prompt: 'grass', answer: 'prisoner' },
      { prompt: 'coach', answer: 'perspective' }
    ];    
  }
